        				...
        				<div class="form-group">
        					<div class="col-sm-12">
        						<c:if test="${not empty model.id }">
        							<input type="button" class="form-control" id="btnAddOrUpdateNew" value="Cập nhật bài viết"/>
        						</c:if>
        						<c:if test="${empty model.id }">
        							<input type="button" class="form-control" id="btnAddOrUpdateNew" value="Thêm mới bài viết"/>
        						</c:if>
        					</div>
        				</div>
